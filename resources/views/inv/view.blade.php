    ...
    <div class="col-lg-12">
        <div class="top-campaign">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_inv" class="form-control" value="{{$inv->no_inv}}" readonly required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" name="tgl_inv" class="form-control" value="{{ $inv->tgl_inv }}" readonly required>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Pajak (%)</td>
                            <td><input type="number" id="pajak" name="pajak" class="form-control" value="{{$inv->pajak}}" onkeyup="total2()" readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Shipping</td>
                            <td><input type="text"  id="shipp" name="shipp" class="form-control" value="{{$inv->shipping}}" onkeyup="total3()" readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" cols="20" rows="5" class="form-control" disabled>{{$inv->desc}}</textarea>
            </div>
        </div>
    </div>
</div>
