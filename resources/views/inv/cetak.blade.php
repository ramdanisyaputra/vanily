...
<body>
    <div class="invoice-box">
        ...
        <strong><p align="right" >INVOICE</strong></p><br>
        <div style="float:right" width="50%">
            No : {{$inv->no_inv}} <br>
            Project : {{$inv->po->qt->rfq->projectname}} <br><br>
        </div>
        <div style="width:48%">
            Date : {{$inv->tgl_inv}} <br>
            ...
            <!--<table>-->
            <!--    <td>-->
            {{$inv->po->qt->rfq->client->companyname}} <br>
            {{$inv->po->qt->rfq->client->address}} <br>
        </div>  
<br>
