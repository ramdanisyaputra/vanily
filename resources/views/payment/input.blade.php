    ...
    <div class="col-lg-12">
        <div class="top-campaign">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_payment" class="form-control" placeholder="Fill No payment" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" name="tgl_payment" class="form-control" value="{{ date('Y-m-d') }}" readonly required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $inv->po->qt->rfq->projectname }}" readonly required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Client</label>
                        <input type="text" class="form-control" value="{{ $inv->po->qt->rfq->client->companyname }}" readonly required>
                    </div>
                </div>
            </div>
            <hr style="border: 1px solid black; margin-bottom : 30px">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Pajak (%)</td>
                            <td><input type="number" id="pajak" name="pajak" class="form-control" value="{{$inv->pajak}}" onkeyup="total2()"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                            <td>Total Pajak</td>
                            <td><input type="text"  name="totalpajak" class="form-control" id="tpajak" value="{{($inv->pajak * $total)/ 100}}" required readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                            <td>Shipping</td>
                            <td><input type="text"  id="shipp" name="shipping" class="form-control" onkeyup="total3()" value="{{$inv->shipping}}" ></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                            <td>Grand Total</td>
                            <td><input type="text"  name="grandtotal" class="form-control" id="grand" value="{{$inv->total}}" required readonly></td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" cols="20" rows="5" class="form-control">{{$inv->desc}}</textarea>
            </div>
...
<script type="text/javascript">
    function hrg() {
        ...
        var shipp = document.getElementById('shipp').value = null;
