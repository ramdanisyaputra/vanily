    ...
    <div class="col-lg-12">
        <div class="top-campaign">
            <h3 class="title-3 m-b-30">
                data payment
                &nbsp;
                <a href="{{route('payment.create')}}" title="Tambah" class="btn btn-primary btn-sm rounded-circle">
