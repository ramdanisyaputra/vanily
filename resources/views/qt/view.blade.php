    ...
    <div class="col-lg-12">
        <div class="top-campaign">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label>No QT</label>
                        <input type="text" name="no_qt" class="form-control" value="{{$qt->no_qt}}" readonly required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_qt" class="form-control" value="{{ $qt->tgl_qt }}" readonly required>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Pajak (%)</td>
                            <td><input type="number" id="pajak" name="pajak" class="form-control" value="{{$qt->pajak}}" onkeyup="total2()" readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                            <td>Total Pajak</td>
                            <td><input type="text"  name="totalpajak" class="form-control" id="tpajak" value="{{($qt->pajak * $total)/ 100}}" required readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                            <td>Grand Total</td>
                            <td><input type="text"  name="grandtotal" class="form-control" id="grand" value="{{$qt->total}}" required readonly></td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" cols="20" rows="5" class="form-control" disabled>{{$qt->desc}}</textarea>
            </div>
        </div>
    </div>
</div>
