    ...
    <div class="col-lg-12">
        <div class="top-campaign">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label>No Do</label>
                        <input type="text" name="no_do" class="form-control" placeholder="Fill No Do" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" name="tgl_do" class="form-control" value="{{ date('Y-m-d') }}" readonly required>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Pajak (%)</td>
                            <td><input type="number" id="pajak" name="pajak" class="form-control" value="{{$payment->pajak}}" onkeyup="total2()"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td>Shipping</td>
                            <td><input type="text"  id="shipp" name="shipping" class="form-control" onkeyup="total3()" value="{{$payment->shipping}}" ></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" cols="20" rows="5" class="form-control">{{$payment->desc}}</textarea>
            </div>
            <div class="form-group">
                <label>Ship To</label>
                <textarea name="ship_to" id="ship_to" cols="20" rows="5" class="form-control" required></textarea>
            </div>
