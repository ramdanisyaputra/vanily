...
<body>
    <div class="invoice-box">
        ...
        <strong><p align="right" >Delivery Order</strong></p><br>
        <div style="float:right" width="50%">
            No : {{$do->no_do}} <br>
            Date : {{$do->tgl_do}} <br>
            Project : {{$do->payment->inv->po->qt->rfq->projectname}} <br><br>
        </div>
        <div style="width:48%">
            <strong>Kepada</strong><br>
            <!--<table>-->
            <!--    <td>-->
            {{$do->payment->inv->po->qt->rfq->client->companyname}} <br>
            {{$do->payment->inv->po->qt->rfq->client->address}} <br>
        </div>  
<br>
